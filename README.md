# lab2
The dataset is designed for salary predicting, containing records that link individual's IDs to their employment outcome.
The primary features identified in the file are: 
ID: A unique identifier.
Placement Status: A categorical indicator.
